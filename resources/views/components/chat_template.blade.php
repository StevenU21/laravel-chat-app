                        ...
                        <a href="javascript:;" class="d-block p-2">
                            <div class="d-flex p-2">
                                ...
                                <div class="ms-3">
                                    ...
                                    <span class="text-muted text-sm col-11 p-0 text-truncate d-block">You can subscribe
                                        to
                                        receive
                                        weekly...</span>
                                </div>
                        ...
                        <a href="javascript:;" class="d-block p-2">
                            <div class="d-flex p-2">
                                ...
                                <div class="ms-3">
                                    ...
                                    <span class="text-muted text-sm col-11 p-0 text-truncate d-block">Be sure to check
                                        it
                                        out if your
                                        dev pro...</span>
                                </div>
