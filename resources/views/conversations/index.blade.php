                    ...
                    <div class="card-body p-2">
                        <a href="javascript:;" class="d-block p-2 border-radius-lg bg-gradient-primary">
                            <div class="d-flex p-2">
                                <img alt="Image" src="{{ asset('img/team-2.jpg') }}" class="avatar shadow">
                                <div class="ms-3">
                        ...
                        <a href="javascript:;" class="d-block p-2">
                            <div class="d-flex p-2">
                                <img alt="Image" src="{{ asset('img/team-1.jpg') }}" class="avatar shadow">
                                <div class="ms-3">
                        ...
                        <a href="javascript:;" class="d-block p-2">
                            <div class="d-flex p-2">
                                ...
                                <div class="ms-3">
                                    ...
                                    <span class="text-muted text-sm col-11 p-0 text-truncate d-block">You can subscribe to
                                        receive
                                        weekly...</span>
                                </div>
                            </div>
                        ...
                        <a href="javascript:;" class="d-block p-2">
                            <div class="d-flex p-2">
                                <img alt="Image" src="{{ asset('img/team-5.jpg') }}" class="avatar shadow">
                                <div class="ms-3">
                                    <h6 class="mb-0">Sofia Scarlett</h6>
                                    <p class="text-muted text-xs mb-2">7 hours ago</p>
                                    <span class="text-muted text-sm col-11 p-0 text-truncate d-block">It’s an effective
                                        resource
                                        regardless..</span>
                                </div>
                            </div>
                        ...
                        <a href="javascript:;" class="d-block p-2">
                            <div class="d-flex p-2">
                                ...
                                <div class="ms-3">
                                    ...
                                    <span class="text-muted text-sm col-11 p-0 text-truncate d-block">Be sure to check it
                                        out if your
                                        dev pro...</span>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-10 col-8">
                                <div class="d-flex align-items-center">
                                    <img alt="Image" src="{{ asset('img/team-2.jpg') }}" class="avatar">
                                    <div class="ms-3">
